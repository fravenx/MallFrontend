  ...
  <div style="width: 80%; margin-left: 50%; transform: translate(-50%)">
    ...
    <div v-if="isLogin && cartProducts.length > 0">
      <el-row type="flex" class="header">
        <el-col class="nav" style="width: 4.16667%"> </el-col>
        <el-col class="nav" style="width: 16%"> 商品图片 </el-col>
        <el-col class="nav" style="width: 16.5%"> 商品名称 </el-col>
        <el-col class="nav" style="width: 9%">单价</el-col>
        <el-col class="nav" style="width: 11%">数量</el-col>
        <el-col class="nav" style="width: 11%">总计</el-col>
        <el-col class="nav" style="width: 9%">优惠后</el-col>
        <el-col class="nav" style="width: 17% ;text-align: center">操作</el-col>
      </el-row>
      <CartItem
...
export default {
  ...
  methods: {
    toCheckout() {
      //先验证基本信息：用户名、联系方式、地址是否填写，填写之后才能进行下一步
      if(this.realName==''||this.address==''||this.telephone==''){
        this.$message.error('基本信息不完整，请补充完整后再购买！')
      }
      else{
        let obj = {
          total: this.total,
