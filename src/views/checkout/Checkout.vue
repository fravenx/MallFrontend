  ...
  >
    ...
    <div class="info-bd">
      <el-row type="flex" justify="end">
        ...
        <el-col :span="3" class="bottom-item" style="color: #999">
          收件人：{{ realName }}
        </el-col>
        <el-col :span="6" class="bottom-item" style="color: #999">
          联系方式：{{ telephone }}
        </el-col>
...
Blog
About
mall-system/Checkout.vue at main · Hacker-C/mall-system Octotree
Login with GitHub
